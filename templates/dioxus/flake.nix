  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        remoteVersionUrl =
          "https://raw.githubusercontent.com/monadimi/nix-env/main/templates/dioxus/version";
        remoteFlakeUrl =
          "https://raw.githubusercontent.com/monadimi/nix-env/main/templates/dioxus/flake.nix";

        updateScript = pkgs.writeShellScriptBin "dioxus-flake-self-update" ''
          set -euo pipefail
          ...
          read_remote_version_file() {
            curl -fsSL --max-time 5 "https://raw.githubusercontent.com/monadimi/nix-env/main/templates/dioxus/version" 2>/dev/null               | tr -d "\r"               | head -n 1               | sed -e 's/[[:space:]]*$//'
          }
          ...
          curl -fsSL --max-time 10 "https://raw.githubusercontent.com/monadimi/nix-env/main/templates/dioxus/flake.nix" -o "$tmp"
      ...
      in {
        devShells.default = pkgs.mkShell {
          packages = commonTools
            ++ fmtTools
            ++ baseTools
            ++ pkgs.lib.optionals pkgs.stdenv.isLinux linuxDeps ++ [ pkgs.zsh updateScript zshBootstrap ];
          ...
          shellHook = ''
            ...
            if ! dioxus-flake-self-update; then
              echo
        ...
        apps.update-flake = {
          type = "app";
          program = "${updateScript}/bin/dioxus-flake-self-update";
        };
